    ...
    <div className="px-4 py-20 max-w-6xl mx-auto space-y-48 text-white">
      ...
      >
        ...
        >
          ...
          >
            Schluss mit Baukästen. Webklar baut dir eine performante, moderne
            Landingpage – die verkauft.
          </motion.p>
          ...
          >
            ...
            <a
              href="/pakete"
              className="flex items-center justify-center sm:justify-start gap-2 text-gray-300 hover:text-white font-medium transition duration-200 px-4 py-1"
            >
      ...
      >
        ...
        <div className="text-gray-300 text-lg space-y-6 max-w-4xl mx-auto">
          <p>
            Viele Selbstständige und kleine Unternehmen verschenken jeden Tag
            Potenzial, weil ihre Website veraltet, überladen oder gar nicht
            vorhanden ist. Gleichzeitig schrecken Baukastensysteme und
            Agenturpreise von mehreren tausend Euro ab.
          </p>
          <p>
            Webklar ist dein Shortcut zur Online-Sichtbarkeit. Wir liefern dir
            eine hochperformante, mobiloptimierte und SEO-freundliche
            Landingpage – maßgeschneidert, ohne unnötigen Ballast.
          </p>
          <p>
            Unsere Seiten basieren auf sauberem React-Code, werden blitzschnell
            ausgeliefert und holen deine Zielgruppe genau da ab, wo sie sucht:
            bei Google, mobil, bereit zu konvertieren.
          </p>
          <p>
            Keine versteckten Kosten, keine Warteschleifen – nur ehrliches
            Webdesign mit Fokus auf Ergebnisse.
          </p>
        </div>
      </motion.section>
      ...
      >
        <div className="relative z-10">
          ...
          <p className="text-blue-100 mb-6 text-lg max-w-xl mx-auto">
            Hol dir jetzt dein kostenloses Angebot – wir melden uns innerhalb
            von 24 Stunden.
          </p>
          <a href="/kontakt">
            <Button
              size="lg"
              className="text-lg px-6 py-4 hover:bg-white hover:text-blue-600 transition"
            >
              Jetzt anfragen
            </Button>
          </a>
...
function Testimonial({ name, quote }) {
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 shadow-sm">
      ...
      <p className="text-right text-sm font-medium mt-4 text-gray-500">
        – {name}
      </p>
    </div>
  );
