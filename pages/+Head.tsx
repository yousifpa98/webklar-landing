...
export default function Head() {
  ...
  return (
    <>
      ...
      <meta name="description" content="Webklar liefert performante, moderne und SEO-optimierte Landingpages in nur 48 Stunden ab 49 €." />
      ...
      <meta property="og:description" content="Webklar liefert performante, moderne und SEO-optimierte Landingpages in nur 48 Stunden ab 49 €." />
